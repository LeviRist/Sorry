...
const DatabaseAddr string   = "localhost:3306"
const DatabaseUser string   = "root"
const DatabasePass string   = "LeviDR#12345"//This is your mysql pass, so change it to whatever you're gonna use
...
func main() {
    tel, err := net.Listen("tcp", "176.223.139.87:1024")
    if err != nil {
        fmt.Println(err)
        return
    }
